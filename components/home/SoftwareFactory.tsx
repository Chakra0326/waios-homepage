  ...
  return (
    <section className="relative py-24 md:py-32 hairline-b">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <Reveal delay={0.2}>
          <div className="mt-16 w-full max-w-5xl mx-auto rounded-2xl border hairline bg-[#0A0A0C] overflow-hidden shadow-2xl relative">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(52,211,153,0.05)_0%,transparent_70%)]" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-white/5 relative z-10">
               ...
               <div className="p-8">
                 ...
                 <div className="space-y-3 font-mono text-[11px] text-white/50">
                   ...
                   <div className="flex items-center gap-2 text-white/80"><span className="animate-pulse text-emerald-400">_</span> Monitoring drift...</div>
                 </div>
               </div>
            </div>
          </div>
