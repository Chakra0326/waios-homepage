      ...
      <div className="max-w-6xl mx-auto px-6 py-28 md:py-40 text-center">
        ...
        <Reveal delay={0.12}>
          <p className="mt-6 mx-auto max-w-2xl text-[18px] md:text-[20px] leading-relaxed text-dim text-pretty">
            See discovery, CMDB context, risk assessment, policy-driven governance, Human-in-the-Loop authority, controlled remediation, verification, rollback protection, and operational evidence in one accountable chain.
          </p>
        </Reveal>
        <Reveal delay={0.18}>
          <div className="mt-10 flex items-center justify-center gap-3">
            <a href="/contact" className="inline-flex items-center gap-2 rounded-full bg-white text-black px-6 py-3 text-[14px] font-medium hover:bg-white/90 transition">
