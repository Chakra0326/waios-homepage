  ...
  return (
    <section className="relative py-24 md:py-32 hairline-b">
      <div className="max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        <Reveal>
          <div className="text-[12px] tracking-[0.24em] uppercase text-dimmer">EXECUTIVE VISIBILITY</div>
          <h2 className="mt-5 text-[34px] md:text-[48px] leading-[1.05] font-semibold tracking-[-0.025em] text-white text-balance">
            Radical <span className="text-dim">Executive Transparency.</span>
          </h2>
          <p className="mt-5 text-[17px] leading-relaxed text-dim max-w-lg">
            Ask your own data anything: growth, compliance, tenant health. Get answers straight from an immutable audit log. No monthly reports, no filtered dashboards, no waiting.
          </p>
